...
public class EnemyAI : MonoBehaviour
{
    ...
    public void SetMovementMultiplier(float multiplier)
    {
        ...
        Debug.Log($"Enemy {gameObject.name} movement multiplier set to {multiplier}. Current speed: {currentMoveSpeed}");
    }
    ...
    public void SetState(EnemyState newState)
    {
        ...
        {
            Debug.Log($"Enemy {gameObject.name} changing state from {currentState} to {newState}");
    ...
    public void SetStunned(bool stunned, float duration = 0f)
    {
        ...
        {
            stunEndTime = 0f;
            Debug.Log($"Enemy {gameObject.name} unstunned");
        }
    }
